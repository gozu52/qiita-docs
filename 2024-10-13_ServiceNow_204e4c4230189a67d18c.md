...
![従業員ポータル内の自分の申請](ServiceNow/NowPlatform/employee_center/images/emp-center_tiket-page.png)

### クリック後

![申請キャンセルボタン押下後](ServiceNow/NowPlatform/employee_center/images/emp-center_ticket-page_after-btn-click.png)
